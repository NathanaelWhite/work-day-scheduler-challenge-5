  ...
  */
  ...
  for (var i = 0; i < workHours.length; i++) {
    ...
    if (workHours[i] == currentHour) {
      textarea.attr(
        "class",
        "eventtext col-10 description border border-top-dark present"
      );
    }
    if (workHours[i] < currentHour) {
      textarea.attr(
        "class",
        "eventText col-10 description border border-top-dark past"
      );
    }
    if (workHours[i] > currentHour) {
      textarea.attr(
        "class",
        "eventText col-10 description border border-top-dark future"
      );
    }
